...
class StorageManager {
    ...
    async listMetadata(options = null) {
        return this._list(options, STORAGE_PREFIX.HKUBE_METADATA);
    }

    async listStore(options = null) {
        return this._list(options, STORAGE_PREFIX.HKUBE_STORE);
    }

    async listExecution(options = null) {
        return this._list(options, STORAGE_PREFIX.HKUBE_EXECUTION);
    }
    ...
    async deleteResults(options) {
        return this._adapter.delete({ Path: path.join(STORAGE_PREFIX.HKUBE_RESULTS, options.Path) });
    }
}
