...
class StorageHkubePersistency extends StorageBase {
    ...
    createPath({ type, name }) {
        ...
        return path.join(this.clusterName + '-' + STORAGE_PREFIX.HKUBE_PERSISTENCY, type, newName);
    }
}

module.exports = StorageHkubePersistency;
